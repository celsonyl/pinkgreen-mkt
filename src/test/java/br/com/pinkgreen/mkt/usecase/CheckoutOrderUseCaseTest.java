...
class CheckoutOrderUseCaseTest {
    ...
    public OrderDomain getCheckoutOrderGatewayReturn() {
        CustomerDomain customerDomain = CustomerDomain.builder()
                .id("3zyaa7ge0zh64rgooswxbzkmfucl3k")
                .document("947.229.723-46")
                .name("Elza")
        ...
        PaymentDomain paymentDomain = getPaymentByPaymentMethod(addressDomain, PaymentMethod.CREDIT_CARD);
        paymentDomain.setAmount(9066.00);
