...
@RestController
public interface CustomerProductHistoricalAccessControllerApi {

    @ApiOperation(value = "Consulta histórico visualizações de produto do usuário")
    @ApiImplicitParams({
    ...
    ResponseEntity<List<ProductResponse>> getProdutHistoricalAccess(@PathVariable String customerId);
