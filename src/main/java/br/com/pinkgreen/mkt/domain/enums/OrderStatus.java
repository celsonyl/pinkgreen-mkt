...
public enum OrderStatus {
    ORDER_CANCELED,
    ORDER_SHIPPED(ORDER_CANCELED),
    ORDER_EN_ROUTE(ORDER_SHIPPED, ORDER_CANCELED),
    ORDER_IN_SEPARATION(ORDER_EN_ROUTE, ORDER_CANCELED),
    ORDER_STOCK_FAILED(ORDER_CANCELED),
    ORDER_STOCK_RESERVED(ORDER_IN_SEPARATION, ORDER_CANCELED),
