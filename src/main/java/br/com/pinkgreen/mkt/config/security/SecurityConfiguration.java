...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().authorizeRequests()
                ...
                .antMatchers(GET, "/product/favorite_products/{id}").hasAuthority(GET_CUSTOMER_FAVORITE_PRODUCTS.toString())
                .antMatchers(POST, "/product/favorite_products").hasAuthority(GET_CUSTOMER_FAVORITE_PRODUCTS.toString())
                .antMatchers(DELETE, "/product/favorite_products/{productId}/user/{userId}").hasAuthority(DELETE_CUSTOMER_FAVORITE_PRODUCT.toString())
