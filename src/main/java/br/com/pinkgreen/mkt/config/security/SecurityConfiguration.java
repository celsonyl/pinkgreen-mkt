...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().authorizeRequests()
                ...
                .antMatchers(GET, "/product/favorite_products/user/{userId}").hasAuthority(GET_CUSTOMER_FAVORITE_PRODUCTS.toString())
                .antMatchers(POST, "/product/favorite_products/user/{userId}").hasAuthority(ADD_CUSTOMER_FAVORITE_PRODUCT.toString())
                .antMatchers(DELETE, "/product/favorite_products/{skuCode}/user/{userId}").hasAuthority(DELETE_CUSTOMER_FAVORITE_PRODUCT.toString())
                ...
                .antMatchers(GET, "/order/state/ready-to-ship").hasAuthority(GET_ORDERS_READY_TO_SHIP.toString())
